      ...
      <div className="max-w-3xl mx-auto">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="flex justify-between pt-6 border-t border-white-800">
              <Button
                type="button"
                onClick={prevStep}
                disabled={step === 1}
                variant="outline"
                className="border-cyan-400 text-black-300 hover:bg-cyan-500/20 hover:text-white hover:border-cyan-300 disabled:opacity-50 disabled:pointer-events-none transition-all duration-200 shadow-sm font-medium"
              >
                Back
              </Button>
